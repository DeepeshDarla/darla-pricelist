...
+’<div class="room-meta">’+wc+’ window’+(wc!==1?“s”:””)+(rt?’ · <span class="room-total-inline">’+fmt(rt)+’</span>’:’’)+’</div></div>’
...
+’<div class="win-dims">’+win.width+’” W \xd7 ‘+win.height+’” H  ·  Qty: ‘+win.qty+(win.remarks?’ · ‘+esc(win.remarks):’’)+’</div></div>’
...
+’<div class="print-brand"><div class="name">DARLA</div><div class="tag">Sales & Agencies · Mysore</div></div>’
...
+’<div class="body">’
+’• All prices are MRP. Final prices subject to confirmation.<br>’
+’• Quantities auto-calculated from window dimensions.<br>’
+’• Fabric subject to stock availability at time of order.<br>’
+’• Delivery: 3–4 weeks from order confirmation.<br>’
