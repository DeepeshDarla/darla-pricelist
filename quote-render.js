...
function renderTx(t,ri,wi,ti,win){
  ...
  if(!hasc){
    if(t.type==="curtains"){
      html+='<div class="next-wrap"><div class="next-lbl">Select fabric type</div>'
        +'<div class="next-row">'
        +'<button class="nab nab-main" onclick="addComp('+C+',&quot;main&quot;)">&#43; Main Fabric</button>'
        +'<button class="nab nab-sheer" onclick="addComp('+C+',&quot;sheer&quot;)">&#43; Sheer</button>'
        +'</div></div>';
    } else if(t.type==="roman_blinds"){
      html+='<div class="next-wrap"><div class="next-lbl">Select fabric</div>'
        +'<div class="next-row">'
        +'<button class="nab nab-main" onclick="addComp('+C+',&quot;main&quot;)">&#43; Main Fabric</button>'
        +(bm==="double"?'<button class="nab nab-sheer" onclick="addComp('+C+',&quot;sheer&quot;)">&#43; Sheer</button>':''  )
        +'</div></div>';
    } else {
      html+='<button class="nab nab-blind" style="width:100%" onclick="addComp('+C+',&quot;blind&quot;)">&#43; Select Blind Product</button>';
    }
  }
  ...
  if(hasc){
    ...
    if(t.type==="curtains"||t.type==="roman_blinds"){
      ...
      html+='<div class="next-lbl">What\'s next?</div><div class="next-row">';
      if(!hm) html+='<button class="nab nab-main" onclick="addComp('+C+',&quot;main&quot;)">&#43; Add Main</button>';
      if(!hs&&allowSheer) html+='<button class="nab nab-sheer" onclick="addComp('+C+',&quot;sheer&quot;)">&#43; Add Sheer</button>';
      if(hm&&(hs||!allowSheer)) html+='<div class="nab-done">&#10003; '+( allowSheer&&hs?"Main &amp; Sheer added":"Main added")+"</div>";
      html+='</div>';
    } else {
      html+='<button class="nab nab-blind" style="width:100%" onclick="addComp('+C+',&quot;blind&quot;)">&#43; Add Another Blind</button>';
    }
    html+='<div class="next-row" style="margin-top:7px">'
...
function saveDraft(){localStorage.setItem("darla_quote_draft",JSON.stringify(APP.quote));}
